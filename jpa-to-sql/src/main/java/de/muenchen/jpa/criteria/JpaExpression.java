...
public abstract class JpaExpression<X> extends JpaSelection<X> implements Expression<X> {
    ...
    protected final AbstractJpaExpressionFactory factory;

    public JpaExpression(Class<X> cls, AbstractJpaExpressionFactory factory) {
        super(cls);
    ...
    public Predicate isNull() {
        return factory.isNull(this);
    }

    @Override
    public Predicate isNotNull() {
        return factory.isNotNull(this);
    }
    ...
    public Predicate equalTo(Expression<?> expression) {
        return new JpaPredicate(factory, factory.equal(this, expression));
    }

    @Override
    public Predicate equalTo(Object o) {
        return equalTo(factory.literal(o));
    }
